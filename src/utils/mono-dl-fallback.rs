...
pub const MONO_DL_EAGER: ::std::os::raw::c_int = 0;
pub const MONO_DL_LAZY: ::std::os::raw::c_int = 1;
pub const MONO_DL_LOCAL: ::std::os::raw::c_int = 2;
pub const MONO_DL_MASK: ::std::os::raw::c_int = 3;
pub const MONO_DL_GLOBAL: ::std::os::raw::c_int = 4;
